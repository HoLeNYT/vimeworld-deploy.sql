...
При необходимости, можно включить у плагина подключение к ядру, проверку обновлений и обновление информации о сервере(Пример что указывать в **serverId**: TEST_, LOBBY_, SW_, SWT_, CP_, BW_, BWH_, BWQ_, BWT_, OS_ и т.д.(После нижнего подчёркивания id игры указать)).
